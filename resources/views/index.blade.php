...
@section('content')
    ...
    {{--                    <img src="assets/images/food/blog/f1.jpg" class="group-hover:scale-105 duration-500 ease-in-out"--}}
    {{--                         alt="">--}}
    {{--                    <div class="absolute inset-0 bg-slate-900/60"></div>--}}

    {{--                    <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center">--}}
    {{--                        <a href="#!" class="text-white font-semibold text-xl mb-0">غذا</a>--}}
    {{--                    </div>--}}
    {{--                </div>--}}
    {{--                <!-- Category -->--}}
    ...
    {{--                <!-- Category -->--}}
    {{--                <div class="group relative rounded-md shadow-md dark:shadow-gray-800 overflow-hidden">--}}
    {{--                    <img src="assets/images/food/blog/f2.jpg" class="group-hover:scale-105 duration-500 ease-in-out"--}}
    {{--                         alt="">--}}
    {{--                    <div class="absolute inset-0 bg-slate-900/60"></div>--}}

    {{--                    <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center">--}}
    {{--                        <a href="#!" class="text-white font-semibold text-xl mb-0">سالم</a>--}}
    {{--                    </div>--}}
    {{--                </div>--}}
    {{--                <!-- Category -->--}}
    ...
    {{--                <!-- Category -->--}}
    {{--                <div class="group relative rounded-md shadow-md dark:shadow-gray-800 overflow-hidden">--}}
    {{--                    <img src="assets/images/food/blog/f3.jpg" class="group-hover:scale-105 duration-500 ease-in-out"--}}
    {{--                         alt="">--}}
    {{--                    <div class="absolute inset-0 bg-slate-900/60"></div>--}}

    {{--                    <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center">--}}
    {{--                        <a href="#!" class="text-white font-semibold text-xl mb-0">شام</a>--}}
    {{--                    </div>--}}
    {{--                </div>--}}
    {{--                <!-- Category -->--}}
    ...
    {{--                <!-- Category -->--}}
    {{--                <div class="group relative rounded-md shadow-md dark:shadow-gray-800 overflow-hidden">--}}
    {{--                    <img src="assets/images/food/blog/f4.jpg" class="group-hover:scale-105 duration-500 ease-in-out"--}}
    {{--                         alt="">--}}
    {{--                    <div class="absolute inset-0 bg-slate-900/60"></div>--}}

    {{--                    <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center">--}}
    {{--                        <a href="#!" class="text-white font-semibold text-xl mb-0">تعطیلات</a>--}}
    {{--                    </div>--}}
    {{--                </div>--}}
    {{--                <!-- Category -->--}}
    ...
    {{--                <!-- Category -->--}}
    {{--                <div class="group relative rounded-md shadow-md dark:shadow-gray-800 overflow-hidden">--}}
    {{--                    <img src="assets/images/food/blog/f5.jpg" class="group-hover:scale-105 duration-500 ease-in-out"--}}
    {{--                         alt="">--}}
    {{--                    <div class="absolute inset-0 bg-slate-900/60"></div>--}}

    {{--                    <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center">--}}
    {{--                        <a href="#!" class="text-white font-semibold text-xl mb-0">قهوه</a>--}}
    {{--                    </div>--}}
    {{--                </div>--}}
    {{--                <!-- Category -->--}}
    {{--            </div>--}}
